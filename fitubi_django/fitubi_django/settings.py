"""
Django settings for fitubi_django project.
...
ROOT_URLCONF = 'fitubi_django.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'fitubi.my_context_processor.my_cp',
            ],
        },
    },
]

WSGI_APPLICATION = 'fitubi_django.wsgi.application'
...
EMAIL_HOST_USER = 'fitubi.client@gmail.com'
EMAIL_HOST_PASSWORD = celery_client_email_password
EMAIL_PORT = 587
EMAIL_USE_TLS = True
